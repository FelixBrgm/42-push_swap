...
/*   Updated: 2022/06/05 18:21:52 by fbruggem         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../../push_swap.h"

void	stack_sort_helper(t_list **head_min, t_list **head_basic,
	t_list **head_radix, t_list **head_3)
{
...
t_list	**stack_sort(t_stack *stack)
{
	...
	if (head_3 && ft_lstsize(*head_min) > ft_lstsize(*head_3))
		head_min = head_3;
	stack_sort_helper(head_min, head_basic, head_radix, head_3);
	return (head_min);
}
